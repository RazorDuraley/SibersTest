...
Веб-приложение для управления проектами, сотрудниками и задачами. Разработано в рамках тестового задания для компании Sibers.
...
employee@employee.com	Employee123!	Employee
📌 Примечания
База данных создаётся автоматически через миграции.

Загруженные файлы сохраняются в папку wwwroot/uploads/.
